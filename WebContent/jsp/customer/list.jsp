...
<BODY>
	<FORM id="customerForm" name="customerForm"
		action="${pageContext.request.contextPath }/GetCustomerByPageServlet"
		method=post>
										...
										<TABLE id=grid
											...
											<TBODY>
												...
												<TR
													...
													<TD>
													<a href="${pageContext.request.contextPath }/UpdateCustomerServlet?cust_id=${customer.cust_id}">修改</a>
													&nbsp;&nbsp;
													<a href="${pageContext.request.contextPath }/DeleteCustomerServlet?cust_id=${customer.cust_id}">删除</a>
													</TD>
												</TR>
								...
								<TR>
									<TD><SPAN id=pagelink>
											<DIV
												...
												共[<B>${cust_nums}</B>]条记录,[<B id="maxPage">${total_pages}</B>]页
